...
Punkt Zewnętrzny: 32C, 40%.
Punkt Celowy: 24C, 50%.

Ścieżka:
1.  Chłodzenie aż do punktu rosy (chłodnica mokra).
2.  Wyraplanie wilgoci (zmniejszanie $x$).
3.  Podgrzewanie (Reheating) - żeby nie wiać lodowatym powietrzem (12C) na ludzi.
...
### Zadanie Domowe
Zaprojektuj proces zimowy: Zewn (-5C, x=2g/kg). Cel (20C, x=10g/kg). Ile wody trzeba dolać i ile ciepła dostarczyć?
