---
title: "W10: Silniki Spalinowe"
subtitle: "Obiegi Otto, Diesla i Sabathe"
...
5.  **Porównanie Sprawności**
6.  **Ciśnienie Średnie Indykowane**
...
## 5. Obieg Sabathe (Mieszany)

Model najbardziej zbliżony do nowoczesnych diesli szybkoobrotowych (Common Rail).
Ciepło doprowadzane jest częściowo przy $V=const$, a częściowo przy $p=const$.

Jest to uogólnienie obu poprzednich obiegów.
...
1.  **Stopień sprężania $\varepsilon$** to klucz do sprawności.
2.  **Otto:** Ogrzewanie izochoryczne ($V=const$). Ograniczony przez spalanie stukowe.
3.  **Diesel:** Ogrzewanie izobaryczne ($p=const$). Wyższe sprężanie $\rightarrow$ mniejsze zużycie paliwa.
4.  Standard powietrzny ułatwia obliczenia (ciepła właściwe stałe, gaz doskonały).
