...
::: {style="background-color: #89e2aa; padding: 20px; border-radius: 10px; border: 1px solid #63bb81;"}
Załóżmy, że silnik pobiera $Q_H = 100 \text{ kJ}$ ciepła z pieca i wykonuje $W = 30 \text{ kJ}$ pracy.
:::

::: incremental
1.  **Ile ciepła oddaje do otoczenia ($Q_L$)?**
    $$ Q_L = Q_H - W = 100 - 30 = 70 \text{ kJ} $$

2.  **Jaka jest sprawność termiczna ($\eta_{th}$)?**
    $$ \eta_{th} = \frac{W}{Q_H} = \frac{30}{100} = 0.30 = 30\% $$
:::
...
*   Płacimy pracą ($W$) tylko za przenoszenie energii.
$$ COP_{HP} = \frac{Q_H}{W} = \frac{Q_L + W}{W} = \frac{Q_L}{W} + 1 = COP_R + 1 $$
:::
