...
## <i class="bi bi-calculator"></i> Różniczki Zupełne i Niezupełne
...
ggplot() +
  # 1. System (Central Box)
  geom_rect(aes(xmin = -2, xmax = 2, ymin = -1.5, ymax = 1.5), 
            fill = "white", color = "black", size = 1.5) +
  annotate("text", x = 0, y = 0, label = "UKŁAD", size = 8, fontface = "bold") +
  
  # 2. Boundary (Dashed Box) - Osłona Bilansowa
  # Używamy geom_rect z linią przerywaną (symulacja osłony)
  geom_rect(aes(xmin = -3, xmax = 3, ymin = -2.5, ymax = 2.5), 
            fill = NA, color = "black", linetype = "dashed", size = 1) +
  
  # 3. Arrows (Green)
  # Q > 0 (Doprowadzone od góry)
  geom_segment(aes(x = 0, xend = 0, y = 3.5, yend = 1.6), 
               arrow = arrow(length = unit(0.5, "cm"), type = "closed"), 
               color = "#27ae60", size = 2) +
  annotate("text", x = 0, y = 3.9, label = "Q > 0", color = "#27ae60", size = 6, fontface = "bold") +
  ...
  # L < 0 (Doprowadzona z lewej - Praca nad układem)
  geom_segment(aes(x = -4.5, xend = -2.1, y = 0, yend = 0), 
               arrow = arrow(length = unit(0.5, "cm"), type = "closed"), 
               color = "#27ae60", size = 2) +
  annotate("text", x = -5.0, y = 0, label = "L < 0", color = "#27ae60", size = 6, fontface = "bold", hjust=1) +

  # L > 0 (Wykonana w prawo - Praca przez układ)
  geom_segment(aes(x = 2.1, xend = 4.5, y = 0, yend = 0), 
               arrow = arrow(length = unit(0.5, "cm"), type = "closed"), 
               color = "#27ae60", size = 2) +
  annotate("text", x = 5.0, y = 0, label = "L > 0", color = "#27ae60", size = 6, fontface = "bold", hjust=0) +
...
## <i class="bi bi-gear-wide-connected"></i> Praca ($L$)
...
## <i class="bi bi-speedometer2"></i> Entalpia ($H$)
...
::: {.fragment .fade-up .callout-note title="Znaczenie" style="font-size: 0.8em;"}
...
## <i class="bi bi-buildings"></i> Entalpia w Technice
...
## <i class="bi bi-arrow-left-right"></i> Entalpia (E) a Energia Wewnętrzna (U)
