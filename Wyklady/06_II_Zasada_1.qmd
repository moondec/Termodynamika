...
## <i class="bi bi-chat-quote"></i> 3. Sformułowania II Zasady 

### Sformułowanie Kelvina-Plancka{style="border: 2px solid #e60000; padding: 20px; border-radius: 10px; background-color: #fff0f0; font-size: 0.8em;"}
...
### Sformułowanie Clausiusa{.fragment style="border: 2px solid #e60000; padding: 20px; border-radius: 10px; background-color: #fff0f0; font-size: 0.8em;"}
...
*   Gdyby silnik był w 100% sprawny (łamie K-P), możnaby nim zasilić pompę ciepła, co w rezultacie pompowałoby ciepło z zimnego do ciepłego bez udziału pracy z zewnątrz (łamie Clausiusa).
...
::: {.fragment .callout-caution appearance="simple" style="font-size: 0.8em;"}
...
::: {.column width="50%"}
### Proces Odwracalny
::: {style="border: 2px solid #27ae60; padding: 15px; border-radius: 10px; background-color: #eafaf1; font-size: 0.8em; text-align: center; margin-bottom: 20px;"}
Można go cofnąć bez śladu w otoczeniu.
:::

<div style="text-align: center; zoom: 1.5;">
```{mermaid}
%%{init: {'theme': 'default', 'flowchart': { 'htmlLabels': false, 'curve': 'basis' }, 'themeVariables': { 'fontSize': '40px', 'fontFamily': 'Lato', 'primaryColor': '#ffffff', 'edgeLabelBackground':'#ffffff', 'tertiaryColor': '#fff0f0' }}}%%
flowchart LR
    A((Stan 1)) <==> B((Stan 2))

    style A fill:#eafaf1,stroke:#27ae60,stroke-width:4px
    style B fill:#eafaf1,stroke:#27ae60,stroke-width:4px
    linkStyle 0 stroke:#27ae60,stroke-width:4px
```
</div>
:::
...
::: {style="border: 2px solid #e60000; padding: 15px; border-radius: 10px; background-color: #fff0f0; font-size: 0.8em; text-align: center; margin-bottom: 20px;"}
...
flowchart LR
    ...
    style C fill:#fff0f0,stroke:#e60000,stroke-width:4px
    style D fill:#fff0f0,stroke:#e60000,stroke-width:4px
    linkStyle 0 stroke:#e60000,stroke-width:4px
...
::: incremental
1.  **Tarcie** (Ciał satałych i lepkość płynów) - zamiana pracy na ciepło jest jednostronna.
...
## <i class="bi bi-clock-history"></i> Proces Kwazistatyczny (Wewnętrznie Odwracalny) 
...
::: {style="border: 3px solid #e60000; background-color: #fff5f5; padding: 20px; border-radius: 10px; text-align: center; width: fit-content; margin: 0 auto; margin-top: 0; margin-bottom: 0;"}
