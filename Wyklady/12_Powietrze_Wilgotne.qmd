...
## <i class="bi bi-bookmark"></i> 3. Entalpia ($h$) 
...
## <i class="bi bi-bookmark"></i> 5. Przemiany Charakterystyczne {auto-animate=true auto-animate-easing="ease-in-out"}
...
## <i class="bi bi-bookmark"></i> Współczynnik Kierunkowy Przemiany ($\varepsilon$) {style="font-size: 0.85em;"}
...
## <i class="bi bi-bookmark"></i> Przemiana 1: Mieszanie Strumieni Powietrza 
...
## <i class="bi bi-bookmark"></i> Przemiana 2: Nawilżanie Parą Wodną 
...
## <i class="bi bi-bookmark"></i> Nawilżanie Adiabatyczne (Wodą) 
