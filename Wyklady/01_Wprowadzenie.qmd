...
## <i class="bi bi-boxes"></i> Klasyfikacja Układów {auto-animate="true"}
...
%%| fig-align: center
graph TD
    System[Układ Termodynamiczny]
    System --> Isolated[Izolowany]
    System --> Closed[Zamknięty]
    System --> Open[Otwarty]
    
    Isolated -.->|Brak Wymiany| Env
    Closed -->|Tylko Energia| Env
    Open -->|Materia + Energia| Env[Otoczenie]
    
    style System fill:#2c3e50,stroke:#ecf0f1,color:#ecf0f1
    style Open fill:#3498db,stroke:#ecf0f1,color:#fff
    style Closed fill:#e67e22,stroke:#ecf0f1,color:#fff
    style Isolated fill:#e74c3c,stroke:#ecf0f1,color:#fff
    style Env fill:#95a5a6,stroke:#ecf0f1,color:#fff
```
