...
**Metodyka:** $\eta_C = 1 - T_L/T_H$, gdzie $T_H = t_1 + 273{,}15$ K, $T_L = 303{,}15$ K (skraplacz 30$^\circ$C).
...
**Metodyka:** $w = \frac{\dot{m} \cdot v_1}{\pi d^2/4}$, gdzie $v_1 \approx 0{,}08$ m$^3$/kg (objętość właściwa pary R134a na ssaniu).
