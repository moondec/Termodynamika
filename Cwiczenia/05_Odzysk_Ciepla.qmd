...
## 🏭 Projekt: Etap 5 - Wymienniki Ciepła{.smaller}
...
## 🎲 Zadanie 5.2: Generacja Entropii (II Zasada){auto-animate="true"}
...
$$ \dot{B}_{str} = T_0 \cdot \Delta \dot{S}_{gen} $$
...
::: {.fragment}
**Maksymalna praca:**
$$ \dot{B}_{max} = \eta_C \cdot \dot{Q}_{spalin} = 0.489 \cdot 150 \approx \mathbf{73.4 \text{ kW}} $$
...
$$ \psi = 1 - \frac{\dot{B}_{str}}{\dot{B}_{max}} = 1 - \frac{48}{73.4} \approx \mathbf{35\%} $$
:::
...
::: {.columns}
::: {.column width="50%"}
![](../img/he_temp_profile_wsp.png){width="70%" fig-align="center"}
**Współprądowy:**
...
:::
::: {.column width="50%"}
![](../img/he_temp_profile_pre.png){width="70%" fig-align="center"}
**Przeciwprądowy:**
