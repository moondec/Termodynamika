---
title: "Ćwiczenie 6: IAgregat wody lodowej (Chiller)"
format: 
  revealjs:
    slide-number: true
    theme: simple
...
:::
::: {.column width="40%"}
![](../img/Agregat-wody-lodowej-chiller-Carrier-30RBP-520-o-wydajnosci-chlodniczej-520-kW.JPEG?auto=format&fit=crop&q=80&w=800)
:::
:::
...
1.  **Punkt 1 (Ssanie):** Para nasycona sucha ($x=1$) przy $t_o = 2^\circ C$.
...
::: {.fragment .callout-note title="Wniosek: Urządzenie jest bardzo efektywne! Na każdy 1 kW prądu uzyskujemy prawie 6 kW chłodu."}
...
::: {.fragment .callout-warning title="Dlatego skraplacze na dachach wyposażone są w wentylatory i zraszanie wodą — każdy stopień obniżenia $t_k$ poprawia EER!"}
...
![](../img/cycles_comparison.png){width="75%" fig-align="center"}
...
1. Wzrost pracy sprężania ($h_{2'} > h_2$).
2. Przestunięcie punktu dławienia w prawo ($h_{3'} > h_3$) → Mniejsza wydajność chłodnicza $q_o$.
:::
...
::: {.callout-warning style="font-size: 1.8em"}
