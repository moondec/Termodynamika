...
ggplot() +
  ...
  # Punkty węzłowe
  annotate("point", x=c(s1, s2, s2_prim, s3_dub_prim, s3, s4), 
  ...
  theme_bw() + 
  labs(title="Rzeczywisty Obieg Rankine'a (T-s)", 
...
ggplot() +
  ...
  # Points
  annotate("point", x=c(p1$s, p2$s, p3$s, p4$s), 
  ...
  labs(title="Obieg Rankine'a: Wykres h-s (Molliera)",
...
ggplot() +
  ...
  # Labels
  annotate("point", x=c(p3$s, p3a$s, p3b$s, p4$s, p4_old$s), 
  ...
  labs(title="Cykl z Przegrzewem Wtórnym",
